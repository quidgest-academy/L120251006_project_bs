...
namespace GenioMVC.ViewModels.Comme
{
	public class MOV_Menu_461_ViewModel : MenuListViewModel<Models.Comme>
	{
		...
		public TablePartial<MOV_Menu_461_RowViewModel> Menu { get; set; }
		...
		{
// USE /[MANUAL MOV LIST_LIMITS 461]/
		...
		public MOV_Menu_461_ViewModel() : base(null!) { }

		/// <summary>
		/// Initializes a new instance of the <see cref="MOV_Menu_461_ViewModel" /> class.
		/// </summary>
		...
		public MOV_Menu_461_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
		...
		public void Load(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAcomme> Qlisting, ref CriteriaSet conditions)
		{
				...
				CriteriaSet mov_menu_461Conds = CriteriaSet.And();
				...
				conditions.SubSets.Add(mov_menu_461Conds);
				mov_menu_461Conds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
				tableReload &= hasAllRequiredLimits;

// USE /[MANUAL MOV OVERRQ 461]/
...
// USE /[MANUAL MOV OVERRQLIST 461]/
					...
					Menu.Elements = MapMOV_Menu_461(listing);

					Menu.Identifier = "ML461";
					Menu.Slots = new Dictionary<string, List<object>>();

					// Last updated by [CJP] at [2015.02.03]
					// Adds the identifier to each element
					foreach (var element in Menu.Elements)
						element.Identifier = "ML461";
			...
			if (Qlisting.Rows != null)
			{
				foreach (var row in Qlisting.Rows)
				{
					if (Qlisting.NumRegs > 0 && i >= Qlisting.NumRegs) // Copiado da versão antiga do RowsToViewModels
						break;
					Elements.Add(MapMOV_Menu_461(row));
					i++;
				}
			}
...
// USE /[MANUAL MOV VIEWMODEL_CUSTOM MOV_MENU_461]/
