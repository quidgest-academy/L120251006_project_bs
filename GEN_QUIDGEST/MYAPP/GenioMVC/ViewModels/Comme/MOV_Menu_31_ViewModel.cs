...
{
	public class MOV_Menu_31_ViewModel : MenuListViewModel<Models.Comme>
	{
		/// <summary>
...
// USE /[MANUAL MOV LIST_LIMITS 31]/
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			{
				// EPH
				crs = Models.Comme.AddEPH<CSGenioAcomme>(ref u, crs, "ML31");
			...
			if (tableReload)
			{
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					crs.Equals(Models.Comme.AddEPH<CSGenioAcomme>(ref u, null, "ML31"));
			}
...
// USE /[MANUAL MOV OVERRQ 31]/
				...
				if (isToExport)
				{
					...
					Qlisting = Models.ModelBase.Where<CSGenioAcomme>(m_userContext, false, mov_menu_31Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML31", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL MOV OVERRQLIST 31]/
					...
					if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					{
						var m_iCurPag = m_userContext.PersistentSupport.getPagingPos(CSGenioAcomme.GetInformation(), QMVC_POS_RECORD, sorts, mov_menu_31Conds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
						if (m_iCurPag != -1)
							pageNumber = ((m_iCurPag - 1) / numberListItems) + 1;
					}

					ListingMVC<CSGenioAcomme> listing = Models.ModelBase.Where<CSGenioAcomme>(m_userContext, distinct, mov_menu_31Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML31", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		private List<MOV_Menu_31_RowViewModel> MapMOV_Menu_31(ListingMVC<CSGenioAcomme> Qlisting)
		{
		...
		private MOV_Menu_31_RowViewModel MapMOV_Menu_31(CSGenioAcomme row)
		{
