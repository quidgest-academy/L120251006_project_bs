...
{
	public class MOV_Menu_521_ViewModel : MenuListViewModel<Models.Chara>
	{
		/// <summary>
		/// Gets or sets the object that represents the table and its elements.
		/// </summary>
		[JsonPropertyName("Table")]
		public TablePartial<MOV_Menu_521_RowViewModel> Menu { get; set; }
		...
		/// <inheritdoc/>
		public override string Uuid => "1647ff0a-85ba-4bf0-84d7-1d1ad3b4b641";
		...
		{
// USE /[MANUAL MOV LIST_LIMITS 521]/
		...
		public MOV_Menu_521_ViewModel() : base(null!) { }

		/// <summary>
		/// Initializes a new instance of the <see cref="MOV_Menu_521_ViewModel" /> class.
		/// </summary>
		/// <param name="userContext">The current user request context</param>
		public MOV_Menu_521_ViewModel(UserContext userContext) : base(userContext)
		{
		...
		public MOV_Menu_521_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			if (Menu == null)
				Menu = new TablePartial<MOV_Menu_521_RowViewModel>();
			...
			{
				// EPH
				crs = Models.Chara.AddEPH<CSGenioAchara>(ref u, crs, "ML521");
			...
			if (tableReload)
			{
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					crs.Equals(Models.Chara.AddEPH<CSGenioAchara>(ref u, null, "ML521"));
			}
		...
		public void Load(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAchara> Qlisting, ref CriteriaSet conditions)
		{
				...
				CriteriaSet mov_menu_521Conds = CriteriaSet.And();
				...
				conditions.SubSets.Add(mov_menu_521Conds);
				mov_menu_521Conds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
				tableReload &= hasAllRequiredLimits;

// USE /[MANUAL MOV OVERRQ 521]/
				...
				if (isToExport)
				{
					...
					Qlisting = Models.ModelBase.Where<CSGenioAchara>(m_userContext, false, mov_menu_521Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML521", true, firstVisibleColumn: firstVisibleColumn);

// USE /[MANUAL MOV OVERRQLSTEXP 521]/
...
// USE /[MANUAL MOV OVERRQLIST 521]/
					...
					if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					{
						var m_iCurPag = m_userContext.PersistentSupport.getPagingPos(CSGenioAchara.GetInformation(), QMVC_POS_RECORD, sorts, mov_menu_521Conds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
						if (m_iCurPag != -1)
							pageNumber = ((m_iCurPag - 1) / numberListItems) + 1;
					}

					ListingMVC<CSGenioAchara> listing = Models.ModelBase.Where<CSGenioAchara>(m_userContext, distinct, mov_menu_521Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML521", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
					...
					Menu.Elements = MapMOV_Menu_521(listing);
		...
		private List<MOV_Menu_521_RowViewModel> MapMOV_Menu_521(ListingMVC<CSGenioAchara> Qlisting)
		{
			List<MOV_Menu_521_RowViewModel> Elements = [];
			int i = 0;
			...
			if (Qlisting.Rows != null)
			{
				foreach (var row in Qlisting.Rows)
				{
					if (Qlisting.NumRegs > 0 && i >= Qlisting.NumRegs) // Copiado da versão antiga do RowsToViewModels
						break;
					Elements.Add(MapMOV_Menu_521(row));
					i++;
				}
			}
		...
		/// to a MOV_Menu_521_RowViewModel object.
		/// </summary>
		/// <param name="row">The row.</param>
		private MOV_Menu_521_RowViewModel MapMOV_Menu_521(CSGenioAchara row)
		{
			var model = new MOV_Menu_521_RowViewModel(m_userContext, true, _fieldsToSerialize);
			if (row == null)
				return model;
...
// USE /[MANUAL MOV VIEWMODEL_CUSTOM MOV_MENU_521]/
