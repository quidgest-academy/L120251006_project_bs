...
namespace GenioMVC.Controllers
{
	...
	{
		private static readonly NavigationLocation ACTION_MOV_MENU_421 = new NavigationLocation("USER_PROFILE06358", "MOV_Menu_421", "Userp") { vueRouteName = "menu-MOV_421" };


		//
		// GET: /Userp/MOV_Menu_421
