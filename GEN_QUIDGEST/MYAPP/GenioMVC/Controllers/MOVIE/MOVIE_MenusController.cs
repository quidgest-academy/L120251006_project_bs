...
namespace GenioMVC.Controllers
{
	public partial class MovieController : ControllerBase
	{
		...
		//
		// GET: /Movie/MOV_Menu_211
		[ActionName("MOV_Menu_211")]
		[HttpPost]
		public ActionResult MOV_Menu_211([FromBody]RequestMenuModel requestModel)
		{
			...
			MOV_Menu_211_ViewModel model = new MOV_Menu_211_ViewModel(UserContext.Current);
			...
			if (isHomePage)
				Navigation.SetValue("HomePage", "MOV_Menu_211");
			...
			if (!isHomePage &&
				(Navigation.CurrentLevel == null || !ACTION_MOV_MENU_211.IsSameAction(Navigation.CurrentLevel.Location)) &&
				Navigation.CurrentLevel.Location.Action != ACTION_MOV_MENU_211.Action)
				CSGenio.framework.Audit.registAction(UserContext.Current.User, Resources.Resources.MENU01948 + " " + Navigation.CurrentLevel.Location.ShortDescription());
			else if (isHomePage)
			{
				CSGenio.framework.Audit.registAction(UserContext.Current.User, Resources.Resources.MENU01948 + " " + ACTION_MOV_MENU_211.ShortDescription());
