...
namespace GenioMVC.Controllers
{
	public partial class MovieController : ControllerBase
	{
		...
		public MovieController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL MOV CONTROLLER_NAVIGATION MOVIE]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAmovie>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL MOV MANUAL_CONTROLLER MOVIE]/
		...
		/// <summary>
		/// Recalculate formulas of the "F_movies" form. (++, CT, SR, CL and U1)
		/// </summary>
		/// <param name="formData">Current form data</param>
		/// <returns></returns>
		[HttpPost]
		public JsonResult RecalculateFormulas_F_movies([FromBody]F_movies_ViewModel formData)
		{
			return GenericRecalculateFormulas(formData, "movie",
				(primaryKey) => Models.Movie.Find(primaryKey, UserContext.Current, "FF_MOVIES"),
		...
		{
			return base.GetDocumsTickets("MOVIE", requestModel.FieldName, requestModel.KeyValue);
		}
