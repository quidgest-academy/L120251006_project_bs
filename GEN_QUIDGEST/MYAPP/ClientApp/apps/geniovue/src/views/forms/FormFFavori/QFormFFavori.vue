				...
				<q-row-container v-if="controls.F_FAVORIUSERPNAME____.isVisible || controls.F_FAVORIFAVORFAVDATE_.isVisible || controls.F_FAVORIMOVIETITLE___.isVisible">
					<q-control-wrapper
						...
						<base-input-structure
							v-if="controls.F_FAVORIUSERPNAME____.isVisible"
							class="i-text"
							v-bind="controls.F_FAVORIUSERPNAME____"
							v-on="controls.F_FAVORIUSERPNAME____.handlers"
							:loading="controls.F_FAVORIUSERPNAME____.props.loading"
							:reporting-mode-on="reportingModeCAV"
							:suggestion-mode-on="suggestionModeOn">
							<q-lookup
								v-if="controls.F_FAVORIUSERPNAME____.isVisible"
								v-bind="controls.F_FAVORIUSERPNAME____.props"
								v-on="controls.F_FAVORIUSERPNAME____.handlers" />
							<q-see-more-f-favoriuserpname
								v-if="controls.F_FAVORIUSERPNAME____.seeMoreIsVisible"
								v-bind="controls.F_FAVORIUSERPNAME____.seeMoreParams"
								v-on="controls.F_FAVORIUSERPNAME____.handlers" />
						</base-input-structure>
					</q-control-wrapper>
					<q-control-wrapper
					...
					<q-control-wrapper
						...
						<base-input-structure
							v-if="controls.F_FAVORIMOVIETITLE___.isVisible"
							class="i-text"
							v-bind="controls.F_FAVORIMOVIETITLE___"
							v-on="controls.F_FAVORIMOVIETITLE___.handlers"
							:loading="controls.F_FAVORIMOVIETITLE___.props.loading"
							:reporting-mode-on="reportingModeCAV"
							:suggestion-mode-on="suggestionModeOn">
							<q-lookup
								v-if="controls.F_FAVORIMOVIETITLE___.isVisible"
								v-bind="controls.F_FAVORIMOVIETITLE___.props"
								v-on="controls.F_FAVORIMOVIETITLE___.handlers" />
							<q-see-more-f-favorimovietitle
...
<script>
	...
	import FormViewModel from './QFormFFavoriViewModel.js'

	const requiredTextResources = ['QFormFFavori', 'hardcoded', 'messages']

/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL MOV FORM_INCLUDEJS F_FAVORI]/
...
/* eslint-enable indent, vue/html-indent, vue/script-indent */
	...
	export default {
		...
		components: {
			QSeeMoreFFavoriuserpname: defineAsyncComponent(() => import('@/views/forms/FormFFavori/dbedits/FFavoriuserpnameSeeMore.vue')),
			QSeeMoreFFavorimovietitle: defineAsyncComponent(() => import('@/views/forms/FormFFavori/dbedits/FFavorimovietitleSeeMore.vue')),
		},
		...
		data()
		{
			...
			const vm = this
			return {
				componentOnLoadProc: asyncProcM.getProcListMonitor('QFormFFavori', false),

				interfaceMetadata: {
					id: 'QFormFFavori', // Used for resources
				...
				controls: {
					F_FAVORIUSERPNAME____: new fieldControlClass.LookupControl({
						...
						lookupKeyModelField: {
							name: 'ValCoduserp',
							dependencyEvent: 'fieldChange:favor.coduserp'
						},
						dependentFields: () => ({
					...
					F_FAVORIMOVIETITLE___: new fieldControlClass.LookupControl({
						...
						lookupKeyModelField: {
							name: 'ValMovieid',
							dependencyEvent: 'fieldChange:favor.movieid'
						},
						dependentFields: () => ({
				...
				dataApi: {
					Favor: {
						...
						get ValFavorite_at() { return vm.model.ValFavorite_at.value },
						set ValFavorite_at(value) { vm.model.ValFavorite_at.updateValue(value) },
					...
					keys: {
						/** The primary key of the FAVOR table */
						get favor() { return vm.model.ValCodfavor },
		...
		{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL MOV FORM_CODEJS F_FAVORI]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		},
		...
		{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL MOV COMPONENT_BEFORE_UNMOUNT F_FAVORI]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		},
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL MOV BEFORE_LOAD_JS F_FAVORI]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL MOV FORM_LOADED_JS F_FAVORI]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			},
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL MOV BEFORE_APPLY_JS F_FAVORI]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL MOV AFTER_APPLY_JS F_FAVORI]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			},
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL MOV BEFORE_SAVE_JS F_FAVORI]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL MOV AFTER_SAVE_JS F_FAVORI]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL MOV BEFORE_DEL_JS F_FAVORI]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL MOV AFTER_DEL_JS F_FAVORI]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL MOV BEFORE_EXIT_JS F_FAVORI]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL MOV AFTER_EXIT_JS F_FAVORI]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			},
			...
			{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL MOV DLGUPDT F_FAVORI]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			...
			{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL MOV CTRLBLR F_FAVORI]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			...
			{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL MOV CTRLUPD F_FAVORI]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL MOV FUNCTIONS_JS F_FAVORI]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		},
