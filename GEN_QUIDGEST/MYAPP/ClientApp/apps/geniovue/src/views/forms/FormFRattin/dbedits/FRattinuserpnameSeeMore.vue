<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-f-rattinuserpname-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['F_RATTINUSERPNAME_____SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'FRattinuserpnameSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('F_RATTINUSERPNAME_____SeeMore', false),

				interfaceMetadata: {
					id: 'F_RATTINUSERPNAME_____SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'F_RATTINUSERPNAME_____SeeMore',
					name: 'F_RATTINUSERPNAME_____SeeMore',
					controller: 'RATTI',
					action: 'F_RATTIN_UserpValName'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				...
				isActive: true,
				returnElement: 'F_RATTINUSERPNAME_____see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			removeModal('see-more-f-rattinuserpname')
		},
