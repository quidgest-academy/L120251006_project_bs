<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-f-rattinmovietitle-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['F_RATTINMOVIETITLE____SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'FRattinmovietitleSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('F_RATTINMOVIETITLE____SeeMore', false),

				interfaceMetadata: {
					id: 'F_RATTINMOVIETITLE____SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'F_RATTINMOVIETITLE____SeeMore',
					name: 'F_RATTINMOVIETITLE____SeeMore',
					controller: 'RATTI',
					action: 'F_RATTIN_MovieValTitle'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-f-rattinmovietitle',
				...
				isActive: true,
				returnElement: 'F_RATTINMOVIETITLE____see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			removeModal('see-more-f-rattinmovietitle')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						uuid: 'F_rattin_F_rattin_MovieValTitle',
