...
export class QAsyncProcessMonitor
{
	...
	constructor(identifier, defaultValueLoaded)
	{
		...
		this.loaded = computed(() => (!this.processList.hasAny ? this._defaultValueLoaded : this.processList.allLoaded) && this.monitors.value.every((m) => m.loaded))
	...
	associateMonitor(monitor)
	{
		if (typeof monitor !== 'undefined' && !(monitor instanceof QAsyncProcessMonitor))
			throw new TypeError('The "monitor" argument must be an instance of QAsyncProcessMonitor.')
