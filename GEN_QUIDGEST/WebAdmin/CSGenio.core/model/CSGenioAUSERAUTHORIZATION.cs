...
namespace CSGenio.business
{
	...
	public class CSGenioAuserauthorization : DbArea
	{
		...
		private static AreaInfo InicializaAreaInfo()
		{
			...
			info.ParentTables.Add("psw", new Relation("MOV", "userauthorization", "userauthorization", "codua", "codpsw", "MOV", "userlogin", "psw", "codpsw", "codpsw"));
		...
		// USE /[MANUAL MOV TABAUX UserAuthorization]/
