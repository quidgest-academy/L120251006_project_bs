    ...
    public class PersistentSupportSQLServer : PersistentSupport
    {
        ...
        public override void transferMSMQLog(bool all)
        {
            ...
            if (!all && Configuration.MaxLogRowDays > 0)
            {
                ...
                filterMQQueues.LesserOrEqual("MOVMQQueues_History", "DATASTATUS", lastDate);
            }
                ...
                using (System.Data.SqlClient.SqlTransaction logTransaction = (System.Data.SqlClient.SqlTransaction)this.Connection.BeginTransaction())
                {
                    try
                    {
                        ...
                        SelectQuery query = new SelectQuery()
                            .Select("MOVMQQueues_History", "CODMQQUEUES", "CODMQQUEUES")
                            .Select("MOVMQQueues_History", "QUEUEID", "QUEUEID")
							.Select("MOVMQQueues_History", "CHANNELID", "CHANNELID")
                            .Select("MOVMQQueues_History", "ANO", "ANO")
                            .Select("MOVMQQueues_History", "USERNAME", "USERNAME")
                            .Select("MOVMQQueues_History", "TABELA", "TABELA")
                            .Select("MOVMQQueues_History", "TABELACOD", "TABELACOD")
                            .Select("MOVMQQueues_History", "QUEUEKEY", "QUEUEKEY")
                            .Select("MOVMQQueues_History", "QUEUE", "QUEUE")
                            .Select("MOVMQQueues_History", "MQSTATUS", "MQSTATUS")
                            .Select("MOVMQQueues_History", "DATASTATUS", "DATASTATUS")
                            .Select("MOVMQQueues_History", "DATACRIA", "DATACRIA")
                            .Select("MOVMQQueues_History", "OPERACAO", "OPERACAO")
                            .Select("MOVMQQueues_History", "RESPOSTA", "RESPOSTA")
                            .Select("MOVMQQueues_History", "SENDNUMBER", "SENDNUMBER")
                            .Select("MOVMQQueues_History", "ZZSTATE", "ZZSTATE")
                            .From("MOVMQQueues_History")
                            .Where(filterMQQueues)
                            .OrderBy("MOVMQQueues_History", "DATACRIA", Quidgest.Persistence.GenericQuery.SortOrder.Ascending);
                        ...
                        using (IDataReader dr = command.ExecuteReader())
                        {
                            ...
                            using (System.Data.SqlClient.SqlBulkCopy bulkCopy = new System.Data.SqlClient.SqlBulkCopy(
                                ...
                                logTransaction))
                            {
                                bulkCopy.DestinationTableName = "dbo.MOVMQQueues_History";
