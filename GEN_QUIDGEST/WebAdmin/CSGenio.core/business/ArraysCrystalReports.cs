...
namespace CSGenio.business
{
    ...
    public class ArraysCrystalReports
    {
        ...
        static ArraysCrystalReports()
		{
            ...
            Qresult.Append("\"                                              \"");
            todasArrays.Add("genre", Qresult.ToString());
			// moviegenre
            Qresult = new StringBuilder();
			            Qresult.AppendLine("if {{{0}}} = \"Drama\" then \"Drama\" else");
			            Qresult.AppendLine("if {{{0}}} = \"Comedy\" then \"Comedy\" else");
			            Qresult.AppendLine("if {{{0}}} = \"Thriller\" then \"Thriller\" else");
			            Qresult.AppendLine("if {{{0}}} = \"Action\" then \"Action\" else");
			            Qresult.AppendLine("if {{{0}}} = \"Romance\" then \"Romance\" else");
            Qresult.Append("\"                                              \"");
            todasArrays.Add("moviegenre", Qresult.ToString());
			// s_modpro
            Qresult = new StringBuilder();
