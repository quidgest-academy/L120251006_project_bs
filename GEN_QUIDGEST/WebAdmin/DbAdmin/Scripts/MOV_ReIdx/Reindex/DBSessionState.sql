...
SET @SQL = N'
CREATE DATABASE [ASPStateMOV]
 CONTAINMENT = NONE
 ON  PRIMARY 
	(NAME = N''ASPStateMOV'', FILENAME = N''' + @SQLDataFolder + 'ASPStateMOV.mdf'' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB ), 
 FILEGROUP [ASPStateMOV_mod] CONTAINS MEMORY_OPTIMIZED_DATA  DEFAULT
	(NAME = N''ASPStateMOV_mod'', FILENAME = N''' + @SQLLogFolder + 'ASPStateMOV_mod'' , MAXSIZE = UNLIMITED)
 LOG ON 
	(NAME = N''ASPStateMOV_log'', FILENAME = N''' + @SQLLogFolder + 'ASPStateMOV_log.ldf'' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB );

ALTER DATABASE [ASPStateMOV] SET COMPATIBILITY_LEVEL = 130; ALTER DATABASE [ASPStateMOV] SET MEMORY_OPTIMIZED_ELEVATE_TO_SNAPSHOT=ON;'
