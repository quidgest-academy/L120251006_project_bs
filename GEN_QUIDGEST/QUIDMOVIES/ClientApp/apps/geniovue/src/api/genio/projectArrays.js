 ...
 * The GENRE array.
 */
export class QArrayGenre
{
	// eslint-disable-next-line @typescript-eslint/no-unused-vars
	constructor(fnResources)
	{
		this.type = 'C'
		this.pluralName = 'GENRE63303'
		this.singularName = 'GENRE63303'
...
/**
 * The MOVIEGENRE array.
 */
export class QArrayMoviegenre
{
	// eslint-disable-next-line @typescript-eslint/no-unused-vars
	constructor(fnResources)
	{
		this.type = 'C'
		this.pluralName = 'MOVIES_GENRE22042'
		this.singularName = 'MOVIES_GENRE22042'

		this.elements = [
			new Option({
				num: 1,
				key: 'Drama',
				resourceId: 'DRAMA24263',
				fnResources,
			}),
			new Option({
				num: 2,
				key: 'Comedy',
				resourceId: 'COMEDY64227',
				fnResources,
			}),
			new Option({
				num: 3,
				key: 'Thriller',
				resourceId: 'THRILLER39900',
				fnResources,
			}),
			new Option({
				num: 4,
