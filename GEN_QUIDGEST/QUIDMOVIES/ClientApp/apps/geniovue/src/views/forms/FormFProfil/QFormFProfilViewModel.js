...
export default class ViewModel extends FormViewModelBase
{
	...
	constructor(vueContext, options, values)
	{
		...
		_merge(this.modelInfo, {
			...
			area: 'USERP',
			actions: {
				recalculateFormulas: 'RecalculateFormulas_F_profil',
				updateFilesTickets: 'UpdateFilesTicketsF_profil',
				setFile: 'SetFileF_profil'
			}
		})
	...
	/**
	 * Creates a clone of the current QFormFProfilViewModel instance.
	 * @returns {QFormFProfilViewModel} A new instance of QFormFProfilViewModel
	 */
	clone()
	{
