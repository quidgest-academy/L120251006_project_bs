<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-f-commenmovietitle-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['F_COMMENMOVIETITLE____SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'FCommenmovietitleSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('F_COMMENMOVIETITLE____SeeMore', false),

				interfaceMetadata: {
					id: 'F_COMMENMOVIETITLE____SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'F_COMMENMOVIETITLE____SeeMore',
					name: 'F_COMMENMOVIETITLE____SeeMore',
					controller: 'COMME',
					action: 'F_COMMEN_MovieValTitle'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-f-commenmovietitle',
				...
				isActive: true,
				returnElement: 'F_COMMENMOVIETITLE____see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			removeModal('see-more-f-commenmovietitle')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						uuid: 'F_commen_F_commen_MovieValTitle',
