<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-f-characmovietitle-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['F_CHARACMOVIETITLE____SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'FCharacmovietitleSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('F_CHARACMOVIETITLE____SeeMore', false),

				interfaceMetadata: {
					id: 'F_CHARACMOVIETITLE____SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'F_CHARACMOVIETITLE____SeeMore',
					name: 'F_CHARACMOVIETITLE____SeeMore',
					controller: 'CHARA',
					action: 'F_CHARAC_MovieValTitle'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-f-characmovietitle',
				...
				isActive: true,
				returnElement: 'F_CHARACMOVIETITLE____see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			removeModal('see-more-f-characmovietitle')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						uuid: 'F_charac_F_charac_MovieValTitle',
