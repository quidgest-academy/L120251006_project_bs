	...
	<teleport
		...
		<div
			...
			<template v-if="formControl.initialized && showFormBody">
				<q-row-container v-if="controls.HOMP____PSEUDFIELD001.isVisible || controls.HOMP____PSEUDFIELD003.isVisible">
					<q-control-wrapper
						v-if="controls.HOMP____PSEUDFIELD001.isVisible || controls.HOMP____PSEUDFIELD003.isVisible"
