...
export default class ViewModel extends FormViewModelBase
{
	...
	constructor(vueContext, options, values)
	{
		...
		_merge(this.modelInfo, {
			...
			area: 'MOVIE',
			actions: {
				recalculateFormulas: 'RecalculateFormulas_F_movies',
				updateFilesTickets: 'UpdateFilesTicketsF_movies',
				setFile: 'SetFileF_movies'
			}
		})
	...
	/**
	 * Creates a clone of the current QFormFMoviesViewModel instance.
	 * @returns {QFormFMoviesViewModel} A new instance of QFormFMoviesViewModel
	 */
	clone()
	{
