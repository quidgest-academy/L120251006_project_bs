...
namespace CSGenio.framework
{
    ...
    public static class Configuration
    {
        ...
        /// System id
        /// </summary>
        public static string Program { get; } = "MOV";

        /// <summary>
        /// Application subsystem
        /// </summary>
        public static readonly ClientApplication Application = ClientApplication.QUIDMOVIES;

        /// <summary>
        /// Modules
        /// </summary>
        public static readonly List<string> Modules = ["MOV"];
        ...
        /// </summary>
        public const int VersionDbGen = 2529;

        /// <summary>
        /// Version of the database indexes
        /// </summary>
        public const int VersionIdxDbGen = 29;
        ...
        /// </summary>
        public const int BuildVersionGen = 113;
        ...
        {
			// USE /[MANUAL MOV RESOLVEDATASYSTEM]/
            DataSystemXml ds;
            switch (db)
            {
