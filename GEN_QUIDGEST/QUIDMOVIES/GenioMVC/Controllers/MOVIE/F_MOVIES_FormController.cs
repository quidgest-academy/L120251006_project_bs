...
// USE /[MANUAL MOV AFTER_CANCEL F_MOVIES]/
		...
		public class F_movies_ValDatacomeModel : RequestLookupModel
		{
			public F_movies_ViewModel Model { get; set; }
		}

		//
		// GET: /Movie/F_movies_ValDatacome
		// POST: /Movie/F_movies_ValDatacome
		[ActionName("F_movies_ValDatacome")]
		public ActionResult F_movies_ValDatacome([FromBody] F_movies_ValDatacomeModel requestModel)
		{
			...
			if (string.IsNullOrEmpty(Navigation.GetStrValue("ForcePrimaryRead_comme")))
				UserContext.Current.SetPersistenceReadOnly(true);
			else
			{
				Navigation.DestroyEntry("ForcePrimaryRead_comme");
			...
			Models.Movie parentCtx = requestModel.Model == null ? null : new(UserContext.Current);
			requestModel.Model?.Init(UserContext.Current);
			requestModel.Model?.MapToModel(parentCtx);
			F_movies_ValDatacome_ViewModel model = new(UserContext.Current, parentCtx);
		...
		public class F_movies_ValDatacharModel : RequestLookupModel
		{
			public F_movies_ViewModel Model { get; set; }
		}

		//
		// GET: /Movie/F_movies_ValDatachar
		// POST: /Movie/F_movies_ValDatachar
		[ActionName("F_movies_ValDatachar")]
		public ActionResult F_movies_ValDatachar([FromBody] F_movies_ValDatacharModel requestModel)
		{
			var queryParams = requestModel.QueryParams;
			...
			requestModel.Model?.Init(UserContext.Current);
			requestModel.Model?.MapToModel(parentCtx);
			F_movies_ValDatachar_ViewModel model = new(UserContext.Current, parentCtx);
