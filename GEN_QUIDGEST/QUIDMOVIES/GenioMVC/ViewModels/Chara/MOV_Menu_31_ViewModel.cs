...
{
	public class MOV_Menu_31_ViewModel : MenuListViewModel<Models.Chara>
	{
		/// <summary>
		...
		/// <inheritdoc/>
		public override string Uuid => "6087e1a7-1c91-4f28-8033-8a60430d40a2";
...
// USE /[MANUAL MOV LIST_LIMITS 31]/
		...
		public override int GetCount(User user)
		{
			...
			FieldRef[] fields = new FieldRef[] { CSGenioAchara.FldCodchara, CSGenioAchara.FldZzstate, CSGenioAchara.FldGenre, CSGenioAchara.FldMovieid, CSGenioAmovie.FldCodmovie, CSGenioAmovie.FldTitle, CSGenioAchara.FldPhoto, CSGenioAchara.FldCreateat, CSGenioAchara.FldName, CSGenioAchara.FldActorname };
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			{
				// EPH
				crs = Models.Chara.AddEPH<CSGenioAchara>(ref u, crs, "ML31");
			...
			if (tableReload)
			{
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					crs.Equals(Models.Chara.AddEPH<CSGenioAchara>(ref u, null, "ML31"));
			}
...
// USE /[MANUAL MOV OVERRQ 31]/
				...
				if (isToExport)
				{
					...
					Qlisting = Models.ModelBase.Where<CSGenioAchara>(m_userContext, false, mov_menu_31Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML31", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL MOV OVERRQLIST 31]/
					...
					if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					{
						var m_iCurPag = m_userContext.PersistentSupport.getPagingPos(CSGenioAchara.GetInformation(), QMVC_POS_RECORD, sorts, mov_menu_31Conds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
						if (m_iCurPag != -1)
							pageNumber = ((m_iCurPag - 1) / numberListItems) + 1;
					}

					ListingMVC<CSGenioAchara> listing = Models.ModelBase.Where<CSGenioAchara>(m_userContext, distinct, mov_menu_31Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML31", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		private List<MOV_Menu_31_RowViewModel> MapMOV_Menu_31(ListingMVC<CSGenioAchara> Qlisting)
		{
		...
		private MOV_Menu_31_RowViewModel MapMOV_Menu_31(CSGenioAchara row)
		{
...
// USE /[MANUAL MOV VIEWMODEL_CUSTOM MOV_MENU_31]/
		...
		[
			"Chara", "Chara.ValCodchara", "Chara.ValZzstate", "Chara.ValGenre", "Movie", "Movie.ValTitle", "Chara.ValPhoto", "Chara.ValCreateat", "Chara.ValName", "Chara.ValActorname", "Chara.ValMovieid"
		];
