...
public class MOV_Menu_521_RowViewModel : Models.Chara
{
	#region Constructors
	...
	public MOV_Menu_521_RowViewModel(UserContext userContext, CSGenioAchara val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
