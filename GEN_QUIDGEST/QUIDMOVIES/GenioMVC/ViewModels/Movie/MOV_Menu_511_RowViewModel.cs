...
public class MOV_Menu_511_RowViewModel : Models.Movie
{
	#region Constructors
	...
	public MOV_Menu_511_RowViewModel(UserContext userContext, CSGenioAmovie val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
