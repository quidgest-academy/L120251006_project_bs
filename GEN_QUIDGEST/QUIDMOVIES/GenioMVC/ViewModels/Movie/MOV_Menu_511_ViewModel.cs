...
{
	public class MOV_Menu_511_ViewModel : MenuListViewModel<Models.Movie>
	{
		/// <summary>
		...
		/// <inheritdoc/>
		public override string Uuid => "dd7d1102-8db7-48e2-aa9e-589fda0424f2";
...
// USE /[MANUAL MOV LIST_LIMITS 511]/
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			{
				// EPH
				crs = Models.Movie.AddEPH<CSGenioAmovie>(ref u, crs, "ML511");
			...
			if (tableReload)
			{
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					crs.Equals(Models.Movie.AddEPH<CSGenioAmovie>(ref u, null, "ML511"));
			}
...
// USE /[MANUAL MOV OVERRQ 511]/
				...
				if (isToExport)
				{
					...
					Qlisting = Models.ModelBase.Where<CSGenioAmovie>(m_userContext, false, mov_menu_511Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML511", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL MOV OVERRQLIST 511]/
					...
					if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					{
						var m_iCurPag = m_userContext.PersistentSupport.getPagingPos(CSGenioAmovie.GetInformation(), QMVC_POS_RECORD, sorts, mov_menu_511Conds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
						if (m_iCurPag != -1)
							pageNumber = ((m_iCurPag - 1) / numberListItems) + 1;
					}

					ListingMVC<CSGenioAmovie> listing = Models.ModelBase.Where<CSGenioAmovie>(m_userContext, distinct, mov_menu_511Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML511", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		private List<MOV_Menu_511_RowViewModel> MapMOV_Menu_511(ListingMVC<CSGenioAmovie> Qlisting)
		{
		...
		private MOV_Menu_511_RowViewModel MapMOV_Menu_511(CSGenioAmovie row)
		{
