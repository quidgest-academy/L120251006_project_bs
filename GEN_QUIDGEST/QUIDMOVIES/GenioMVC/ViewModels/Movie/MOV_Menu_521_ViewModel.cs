...
{
	public class MOV_Menu_521_ViewModel : MenuListViewModel<Models.Movie>
	{
		/// <summary>
...
// USE /[MANUAL MOV LIST_LIMITS 521]/
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			{
				// EPH
				crs = Models.Movie.AddEPH<CSGenioAmovie>(ref u, crs, "ML521");
			...
			if (tableReload)
			{
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					crs.Equals(Models.Movie.AddEPH<CSGenioAmovie>(ref u, null, "ML521"));
			}
...
// USE /[MANUAL MOV OVERRQ 521]/
				...
				if (isToExport)
				{
					...
					Qlisting = Models.ModelBase.Where<CSGenioAmovie>(m_userContext, false, mov_menu_521Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML521", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL MOV OVERRQLIST 521]/
					...
					if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					{
						var m_iCurPag = m_userContext.PersistentSupport.getPagingPos(CSGenioAmovie.GetInformation(), QMVC_POS_RECORD, sorts, mov_menu_521Conds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
						if (m_iCurPag != -1)
							pageNumber = ((m_iCurPag - 1) / numberListItems) + 1;
					}

					ListingMVC<CSGenioAmovie> listing = Models.ModelBase.Where<CSGenioAmovie>(m_userContext, distinct, mov_menu_521Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML521", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		private List<MOV_Menu_521_RowViewModel> MapMOV_Menu_521(ListingMVC<CSGenioAmovie> Qlisting)
		{
		...
		private MOV_Menu_521_RowViewModel MapMOV_Menu_521(CSGenioAmovie row)
		{
