...
{
	public class Homp_ValField002_ViewModel : MenuListViewModel<Models.Movie>
	{
		/// <summary>
		/// Gets or sets the object that represents the table and its elements.
		/// </summary>
		[JsonPropertyName("Table")]
		public TablePartial<Homp_ValField002_RowViewModel> Menu { get; set; }
		...
		/// <inheritdoc/>
		public override string Uuid => "Homp_ValField002";
		...
		{
// USE /[MANUAL MOV LIST_LIMITS HOMP_PSEUDFIELD002]/
		...
		public Homp_ValField002_ViewModel() : base(null!) { }

		/// <summary>
		/// Initializes a new instance of the <see cref="Homp_ValField002_ViewModel" /> class.
		/// </summary>
		/// <param name="userContext">The current user request context</param>
		public Homp_ValField002_ViewModel(UserContext userContext) : base(userContext)
		{
		}
		...
		public Homp_ValField002_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			if (Menu == null)
				Menu = new TablePartial<Homp_ValField002_RowViewModel>();
			...
			{
				// EPH
				crs = Models.Movie.AddEPH<CSGenioAmovie>(ref u, crs, "IBL_HOMP____PSEUDFIELD002");
			...
			if (tableReload)
			{
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					crs.Equals(Models.Movie.AddEPH<CSGenioAmovie>(ref u, null, "IBL_HOMP____PSEUDFIELD002"));
			}
		...
		public void Load(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAmovie> Qlisting, ref CriteriaSet conditions)
		{
				...
				CriteriaSet homp____pseudfield002Conds = CriteriaSet.And();
				...
				conditions.SubSets.Add(homp____pseudfield002Conds);
				homp____pseudfield002Conds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
				tableReload &= hasAllRequiredLimits;

// USE /[MANUAL MOV OVERRQ HOMP_PSEUDFIELD002]/
				...
				if (isToExport)
				{
					...
					Qlisting = Models.ModelBase.Where<CSGenioAmovie>(m_userContext, false, homp____pseudfield002Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_HOMP____PSEUDFIELD002", true, firstVisibleColumn: firstVisibleColumn);

// USE /[MANUAL MOV OVERRQLSTEXP HOMP_PSEUDFIELD002]/
				...
				if (tableReload)
				{
// USE /[MANUAL MOV OVERRQLIST HOMP_PSEUDFIELD002]/
					...
					if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					{
						var m_iCurPag = m_userContext.PersistentSupport.getPagingPos(CSGenioAmovie.GetInformation(), QMVC_POS_RECORD, sorts, homp____pseudfield002Conds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
						if (m_iCurPag != -1)
							pageNumber = ((m_iCurPag - 1) / numberListItems) + 1;
					}

					ListingMVC<CSGenioAmovie> listing = Models.ModelBase.Where<CSGenioAmovie>(m_userContext, distinct, homp____pseudfield002Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_HOMP____PSEUDFIELD002", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
					...
					Menu.Elements = MapHomp_ValField002(listing);

					Menu.Identifier = "IBL_HOMP____PSEUDFIELD002";

					// Last updated by [CJP] at [2015.02.03]
					// Adds the identifier to each element
					foreach (var element in Menu.Elements)
						element.Identifier = "IBL_HOMP____PSEUDFIELD002";
		...
		private List<Homp_ValField002_RowViewModel> MapHomp_ValField002(ListingMVC<CSGenioAmovie> Qlisting)
		{
			List<Homp_ValField002_RowViewModel> Elements = [];
			int i = 0;
			...
			if (Qlisting.Rows != null)
			{
				foreach (var row in Qlisting.Rows)
				{
					if (Qlisting.NumRegs > 0 && i >= Qlisting.NumRegs) // Copiado da versão antiga do RowsToViewModels
						break;
					Elements.Add(MapHomp_ValField002(row));
					i++;
				}
			}
		...
		/// to a Homp_ValField002_RowViewModel object.
		/// </summary>
		/// <param name="row">The row.</param>
		private Homp_ValField002_RowViewModel MapHomp_ValField002(CSGenioAmovie row)
		{
			var model = new Homp_ValField002_RowViewModel(m_userContext, true, _fieldsToSerialize);
			if (row == null)
				return model;
...
// USE /[MANUAL MOV VIEWMODEL_CUSTOM HOMP_VALFIELD002]/
