...
public class MOV_Menu_651_RowViewModel : Models.Ratti
{
	#region Constructors

	public MOV_Menu_651_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public MOV_Menu_651_RowViewModel(UserContext userContext, CSGenioAratti val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
