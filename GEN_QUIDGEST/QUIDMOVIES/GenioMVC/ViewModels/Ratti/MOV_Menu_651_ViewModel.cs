...
{
	public class MOV_Menu_651_ViewModel : MenuListViewModel<Models.Ratti>
	{
		/// <summary>
		/// Gets or sets the object that represents the table and its elements.
		/// </summary>
		[JsonPropertyName("Table")]
		public TablePartial<MOV_Menu_651_RowViewModel> Menu { get; set; }
		...
		{
// USE /[MANUAL MOV LIST_LIMITS 651]/
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet conditions = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "ML651");
		...
		public MOV_Menu_651_ViewModel() : base(null!) { }

		/// <summary>
		/// Initializes a new instance of the <see cref="MOV_Menu_651_ViewModel" /> class.
		/// </summary>
		/// <param name="userContext">The current user request context</param>
		public MOV_Menu_651_ViewModel(UserContext userContext) : base(userContext)
		{
		...
		public MOV_Menu_651_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			if (Menu == null)
				Menu = new TablePartial<MOV_Menu_651_RowViewModel>();
			...
			{
				// EPH
				crs = Models.Ratti.AddEPH<CSGenioAratti>(ref u, crs, "ML651");
			...
			if (tableReload)
			{
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					crs.Equals(Models.Ratti.AddEPH<CSGenioAratti>(ref u, null, "ML651"));
			}
		...
		public void Load(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAratti> Qlisting, ref CriteriaSet conditions)
		{
				...
				CriteriaSet mov_menu_651Conds = CriteriaSet.And();
				...
				//Tooltip for EPHs affecting this viewmodel list
				{
					...
					List<Limit> area_EPH_limits = EPH_Limit_Filler(ref limit, model_limit_area, "ML651");
				...
				conditions.SubSets.Add(mov_menu_651Conds);
				mov_menu_651Conds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
				tableReload &= hasAllRequiredLimits;

// USE /[MANUAL MOV OVERRQ 651]/
				...
				if (isToExport)
				{
					...
					Qlisting = Models.ModelBase.Where<CSGenioAratti>(m_userContext, false, mov_menu_651Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML651", true, firstVisibleColumn: firstVisibleColumn);

// USE /[MANUAL MOV OVERRQLSTEXP 651]/
...
// USE /[MANUAL MOV OVERRQLIST 651]/
					...
					if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					{
						var m_iCurPag = m_userContext.PersistentSupport.getPagingPos(CSGenioAratti.GetInformation(), QMVC_POS_RECORD, sorts, mov_menu_651Conds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
						if (m_iCurPag != -1)
							pageNumber = ((m_iCurPag - 1) / numberListItems) + 1;
					}

					ListingMVC<CSGenioAratti> listing = Models.ModelBase.Where<CSGenioAratti>(m_userContext, distinct, mov_menu_651Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML651", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
					...
					Menu.Elements = MapMOV_Menu_651(listing);

					Menu.Identifier = "ML651";
					Menu.Slots = new Dictionary<string, List<object>>();

					// Last updated by [CJP] at [2015.02.03]
					// Adds the identifier to each element
					foreach (var element in Menu.Elements)
						element.Identifier = "ML651";
		...
		private List<MOV_Menu_651_RowViewModel> MapMOV_Menu_651(ListingMVC<CSGenioAratti> Qlisting)
		{
			List<MOV_Menu_651_RowViewModel> Elements = [];
			int i = 0;
			...
			if (Qlisting.Rows != null)
			{
				foreach (var row in Qlisting.Rows)
				{
					if (Qlisting.NumRegs > 0 && i >= Qlisting.NumRegs) // Copiado da versão antiga do RowsToViewModels
						break;
					Elements.Add(MapMOV_Menu_651(row));
					i++;
				}
			}
		...
		/// to a MOV_Menu_651_RowViewModel object.
		/// </summary>
		/// <param name="row">The row.</param>
		private MOV_Menu_651_RowViewModel MapMOV_Menu_651(CSGenioAratti row)
		{
			var model = new MOV_Menu_651_RowViewModel(m_userContext, true, _fieldsToSerialize);
			if (row == null)
				return model;
...
// USE /[MANUAL MOV VIEWMODEL_CUSTOM MOV_MENU_651]/
